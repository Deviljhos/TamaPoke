...
static const char *const STRINGS[LANG_COUNT][STR_COUNT] = {
  ...
  // ---------------- AR ----------------
  // Arabe (MSA): formas contextuales y orden visual RTL ya aplicados, porque
  // Arduino_GFX no hace shaping ni bidi. No editar a mano.
  // AR:STRINGS (generated by tools/gen_ar.py - edit tools/ar_strings.py)
  {
    "!ﺭﻮﻄﺘﻳ ﻪﻧﺇ", "!ﺬﻳﺬﻟ", "!ﻪﺒﺠﻋﺃ",
    "!ﻊﺋﺎﺟ ﻪﻧﺇ", "!ﻡﺎﻤﺣ ﻰﻟﺇ ﺝﺎﺘﺤﻳ", "...ﻚﻬﻨﻣ",
    "...ﻦﻳﺰﺣ", "...ﻼﻴﻠﻗ ﺊﻠﺘﻤﻣ", "!!ﻊﻣﻻ ﻪﻧﺇ",
    "ﺪﻴﻌﺳ ﻪﻧﺇ", "ﺎﻋﺍﺩﻭ !ﺍﺮﻜﺷ", "...ﺏﺮﻫ ﺪﻘﻟ",
    "ﺎﻋﺩﻮﻣ ﺡﻮﻠﻳ !ﺔﻣﻼﺴﻟﺍ ﻊﻣ", "ﺔﻀﻴﺑ", "؟!ﺔﻳﺭﻮﻄﺳﺃ ﺔﻀﻴﺑ",
    "!ﺓﺭﺩﺎﻧ ﺔﻀﻴﺑ", "...ﺔﻀﻴﺒﻟﺍ ﺲﻤﻟﺍ", "!ﻙﺮﺤﺘﺗ ﺎﻬﻧﺇ",
    "!ﺲﻘﻔﻟﺍ ﻰﻠﻋ ﺖﻜﺷﻭﺃ", "%u/151 ﺲﻜﻳﺪﻴﻛﻮﺑ", "%s%s Lv.%u",
    "؟%s ﻕﻼﻃﺇ", "ﻢﻌﻧ", "ﻻ",
    "ﺔﺑﺮﺿ %u", "+%u ﺓﻮﻘﻟﺍ", "!ﺪﻳﺪﺟ ﻲﺳﺎﻴﻗ ﻢﻗﺭ",
    "%u :ﻞﻀﻓﻷﺍ", "!ﺔﻋﺮﺴﺑ ﺏﺮﺿﺍ", "%u :ﻁﺎﻘﻨﻟﺍ",
    "!ﺍﺪﺟ ﻊﺘﻤﻣ", "ﺓﺩﺎﻌﺳ+", "ﺖﻗﻮﻟﺍ ﻂﺒﺿ",
    "ﺔﻋﺎﺳ", "ﺔﻘﻴﻗﺩ", "ﺀﺎﻐﻟﺇ :ﻰﻠﻋﻷ ﺐﺤﺳﺍ",
    "ﺔﻐﻠﻟﺍ", "!ﻡﺎﺳﻭ", "!ﻊﺋﺍﺭ",
    "!ﺔﻴﻟﺎﺘﺘﻣ ﻡﺎﻳﺃ %u", "%u ﺔﻠﺴﻠﺴﻟﺍ  %u ﻞﻀﻓﻷﺍ", "ﺔﻄﺑﺍﺮﻟﺍ",
    "??? ﺔﺗﻮﺗ", "ﺀﺍﺮﻤﺣ ﺔﺗﻮﺗ", "ﺀﺎﻗﺭﺯ ﺔﺗﻮﺗ",
    "ﺀﺍﺮﻀﺧ ﺔﺗﻮﺗ", "%s   ﻡﻮﻳ %lu ﺮﻤﻌﻟﺍ", "ﻩﺮﻴﻴﻐﺘﻟ ﻢﺳﻻﺍ ﺲﻤﻟﺍ",
    "ﺔﻛﺮﻌﻤﻟﺍ", "ﻡﻮﺠﻫ", "ﻉﺎﻓﺩ",
    "ﺔﻋﺮﺳ", "ﻥﺯﻭ", "ﺓﻮﻘﻟﺍ ﺐﻳﺭﺪﺗ",
    "%d/%d ﺔﻤﺳﻭﻷﺍ", "ﻉﻮﺟﺭ :ﺲﻤﻟﺍ", ":ﻢﺳﻻﺍ",
    "ﻉﻮﺟﺮﻠﻟ ﺲﻤﻟﺍ", "ﻡﺎﻌﻃ", "ﺡﺮﻣ",
    "ﺔﻗﺎﻃ", "ﺔﻓﺎﻈﻧ", "%u ﻞﻀﻓﻷﺍ",
    "ﻡﺪﻘﺘﻟﺍ", "%u ﻯﻮﺘﺴﻣ", "ﺔﻘﻴﻗﺩ %u ﺪﻌﺑ %u ﻯﻮﺘﺴﻣ",
    "ﺭﻮﻄﺘﻟﺍ", "ﻲﺋﺎﻬﻨﻟﺍ ﻞﻜﺸﻟﺍ", "!ﺭﻮﻄﺘﻠﻟ ﺰﻫﺎﺟ",
    "ﺭﻮﻄﺘﻠﻟ 40 ﻰﻟﺇ ﻞﻜﻟﺍ ﻊﻓﺭﺍ", "ﻯﻮﺘﺴﻣ %u ﺪﻌﺑ ﺭﻮﻄﺘﻳ", "%u :ﻝﺎﻤﻫﻹﺍ",
    "ﻞﻌﻔﻣ ﺕﻮﺻ", "ﻖﻠﻐﻣ ﺕﻮﺻ", "!ﺭﻮﻄﺗ",
    "...ﻙﺮﺒﺨﻳ ﻥﺃ ﺪﻳﺮﻳ %s", "...ﺓﺪﺣﻮﻟﺎﺑ ﺮﻌﺸﻳ %s", "؟ﺭﻮﻄﺘﻳ ﻞﻫ",
    "ﻞﻜﺸﻟﺍ ﺀﺎﻘﺑﺇ", "؟ﻪﻋﺩﻮﺗ ﻞﻫ", "ﺎﻋﺍﺩﻭ",
    "ﺎﻌﻣ ﺀﺎﻘﺒﻟﺍ", "ﻝﻭﻷﺍ ﻚﻧﻮﻤﻴﻛﻮﺑ ﺮﺘﺧﺍ", "ﻡﻮﺳﺭ ﺪﺟﻮﺗ ﻻ",
    "SD ﺔﻗﺎﻄﺑ ﻰﻠﻋ ﺎﻬﻠﻤﺣ",
  },
  // AR:STRINGS-END (generated by tools/gen_ar.py - edit tools/ar_strings.py)
};
...
static const char *const MED_NAME[LANG_COUNT][MED_COUNT] = {
  ...
  // AR:MED_NAME (generated by tools/gen_ar.py - edit tools/ar_strings.py)
  { "10 ﻯﻮﺘﺴﻣ", "25 ﻯﻮﺘﺴﻣ", "50 ﻯﻮﺘﺴﻣ", "ﺔﺗﻮﺘﻟﺍ", "ﻡﺎﻳﺃ 7", "ﺔﻄﺑﺍﺮﻟﺍ", "ﺔﻤﻘﻟﺍ", "ﺔﻗﺎﻴﻟ", },
  // AR:MED_NAME-END (generated by tools/gen_ar.py - edit tools/ar_strings.py)
};
static const char *const MED_LBL[LANG_COUNT][MED_COUNT] = {
  ...
  // AR:MED_LBL (generated by tools/gen_ar.py - edit tools/ar_strings.py)
  { "10ﻯﻮﺘﺴﻣ", "25ﻯﻮﺘﺴﻣ", "50ﻯﻮﺘﺴﻣ", "ﺔﺗﻮﺗ", "ﻡﺎﻳﺃ7", "ﺔﻄﺑﺍﺭ", "ﺔﻤﻗ", "ﺔﻗﺎﻴﻟ", },
  // AR:MED_LBL-END (generated by tools/gen_ar.py - edit tools/ar_strings.py)
};
static const char *const MED_DSC[LANG_COUNT][MED_COUNT] = {
  ...
  // AR:MED_DSC (generated by tools/gen_ar.py - edit tools/ar_strings.py)
  { "10 ﻯﻮﺘﺴﻤﻟﺍ", "25 ﻯﻮﺘﺴﻤﻟﺍ", "50 ﻯﻮﺘﺴﻤﻟﺍ", "ﺔﺗﻮﺘﻟﺍ ﻑﺎﺸﺘﻛﺍ", "ﺔﻴﻟﺎﺘﺘﻣ ﻡﺎﻳﺃ 7", "ﺔﻄﺑﺍﺭ ﻰﺼﻗﺃ", "ﻲﺋﺎﻬﻨﻟﺍ ﻞﻜﺸﻟﺍ", "ﺔﻣﺎﺗ ﺔﻗﺎﻴﻟ", },
  // AR:MED_DSC-END (generated by tools/gen_ar.py - edit tools/ar_strings.py)
};
